...
const LocationTransferTable = ({ data, perPage }) => {
    perPage += 10;
    ...
    return (
        <Stack justifyContent={'space-between'} sx={{ backgroundColor: 'white', padding: '10px', minHeight: '80vh', width: '100%' }}>
            <TableContainer >
...
export default LocationTransferTable