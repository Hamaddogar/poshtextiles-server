...
const UpdateLineItem = ({ handleSubmitUpdateLineItem, product, handleCancel }) => {
                    ...
                    <Box >
                        <Grid container alignItems='center' spacing={1}>
                            <Grid item xs={6} sm={6} md={3} >
                                ...
                                <TextField required sx={headInputStyle} fullWidth defaultValue={product?.type} name={"itemType"} size='small' />
                            </Grid>

                            <Grid item xs={6} sm={6} md={3}>
                                <Typography component='span' sx={{ color: '#6D6D6D', fontSize: '14px' }}>No. </Typography>
                                <TextField required sx={headInputStyle} fullWidth defaultValue={product?.no} name={"simpleNo"} size='small' />
                            </Grid>

                            <Grid item xs={6} sm={6} md={4}>
                                <Typography component='span' sx={{ color: '#6D6D6D', fontSize: '14px' }}>Description: </Typography>
                                <TextField required sx={headInputStyle} fullWidth defaultValue={product?.description} name={"description"} size='small' />
                            </Grid>
                            ...
                            <Grid item xs={6} sm={6} md={2}>
                                ...
                                <TextField required sx={headInputStyle} fullWidth defaultValue={product?.lineNo} name={"itemNo"} size='small' />
                            </Grid>
                            ...
                            <Grid item xs={6} sm={6} md={2}>
                                ...
                                <TextField required sx={headInputStyle} fullWidth defaultValue={product?.outstandingQuantity} type='number' name={"minQty"} size='small' />
                            </Grid>
                            ...
                            <Grid item xs={6} sm={6} md={2}>
                                ...
                                <TextField required sx={headInputStyle} fullWidth value={((data.price * data.qty) - (data.discount))} type='number' name={"amount"} size='small' />
                            </Grid>

                            <Grid item xs={12}>
                                <Stack spacing={1} direction='row' alignItems='center' justifyContent={'center'} >
                                    <TextField sx={headInputStyle} fullWidth
